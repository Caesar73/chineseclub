...
define('phooer/src/layout/RootLayoutView', [
    'require',
    'exports',
    'module',
    'libs'
...
define('phooer/src/main/app', [
    'libs',
    'phooer/src/layout/RootLayoutView'
], function (libs, RootLayoutView) {
    var libs = require('libs');
    var _ = libs.underscore;
    var $ = libs.jquery;
    var Backbone = libs.Backbone;
...
define('phooer/src/model/common/header', [
    'require',
    'exports',
    'module',
    'libs'
...
define('phooer/src/collection/common/HeaderCollection', [
    'require',
    'exports',
    'module',
    'libs',
    'phooer/src/model/common/header'
], function (require, exports) {
    var libs = require('libs');
    var _ = libs.underscore;
    var $ = libs.jquery;
    var Backbone = libs.Backbone;
    var Marionette = libs.Marionette;
    var Item = require('phooer/src/model/common/header');
...
define('phooer/src/template/common/header.html', [], function () {
    return '\n<div class="top_bar">\n    <div class="abs_m">\n        <a href="#refresh" class="refresh_title btn" action-type="fresh" ga_category="refresh" ga_label="" ga_event="click"></a>\n        <a href="#refresh" class="refresh_btn btn" action-type="fresh" ga_category="refresh" ga_label="" ga_event="click"></a>\n    </div>\n    <div class="abs_l">\n        <a href="javascript:;" class="msg-box" ga_category="left_button" ga_label="" ga_event="click">\n            <div class="circle" style="display:none"></div>\n        </a>\n    </div>\n    <div class="abs_r">\n        <a href="#search/" class="btn search"></a>\n    </div>\n</div>\n<div class="top_menu_bar">\n    <div class="top_menu_more">\n        <div class="list_shadow"></div>\n        <a href="#channel" class="more_btn" ga_category="channel" ga_label="" ga_event="channel_more"></a>\n    </div>\n    <div id="top_menu" class="top_menu">\n        <div class="top_menu_list">\n            <a data-url="channel=all" href="#list/all" class="btn cur" scroll-left="0">推荐</a>\n            <!--\n            <a data-url="channel=latvia" href="javascript:;" class="btn " scroll-left="0">拉脱维亚</a>\n            <a data-url="channel=lithuania" href="javascript:;" class="btn " scroll-left="0">立陶宛</a>\n            <a data-url="channel=estonia" href="javascript:;" class="btn " scroll-left="0">爱沙尼亚</a>\n            <a data-url="channel=belarus" href="javascript:;" class="btn " scroll-left="0">白俄罗斯</a>\n            <a data-url="channel=ukraine" href="javascript:;" class="btn " scroll-left="0">乌克兰</a>\n            -->\n        </div>\n    </div>\n</div>\n\n';
});
define('phooer/src/view/common/HeaderView', [
    'libs',
    'phooer/src/collection/common/HeaderCollection',
    'phooer/src/template/common/header.html'
    ...
    return Marionette.ItemView.extend({
        ...
        render: function (response) {
            ...
            container.on('click', '.top_menu_list a', function (e) {
                var me = $(this);
                var left = me.attr('scroll-left');
                var menu = container.find('#top_menu');
                menu.find('.cur').removeClass('cur');
                me.addClass('cur');
                menu.animate({ 'scrollLeft': left }, 200);
                var type = me.data('url');
            });
        }
    });
});
define('phooer/src/template/common/header-channel.html', [], function () {
    return '\n    <div class="top_bar channel">\n        <div class="abs_l">\n            <a class="btn back" href="#index"></a>\n        </div>\n        <div class="abs_m">\n            频道管理\n        </div>\n    </div>\n';
});
define('phooer/src/view/common/ChannelHeaderView', [
    'libs',
    'phooer/src/template/common/header-channel.html'
...
define('phooer/src/controller/common/HeaderController', [
    'libs',
    'phooer/src/view/common/HeaderView',
    'phooer/src/view/common/ChannelHeaderView',
    'phooer/src/collection/common/HeaderCollection'
], function (libs, HeaderView, ChannelHeaderView, HeaderCollection) {
    var _ = libs.underscore;
    var $ = libs.jquery;
    var Backbone = libs.Backbone;
    var Marionette = libs.Marionette;
...
define('phooer/src/view/common/ChannelView', [
    ...
    return Marionette.ItemView.extend({
        ...
        render: function (data) {
            ...
            container.on('click', '.list.choose-type li', function (e) {
                var me = $(this);
            ...
            function initScrollEvents() {
                ...
                function globalScroll(e) {
                    ...
                    if (scrollY >= theDocumentHeight - innerHeight - offset)
            ...
            function global_tip(str, delay) {
                delay = delay || 3000;
                var p = $('<div class=\'global_tip\'/>').appendTo('body'), h = $('header'), tip_top = 0;
                if (h.length)
                    tip_top = Math.max(0, h.height());
            ...
            var SortMenu = {
                ...
                addEvents: function (obj) {
                    ...
                    this.$selectedList.on('click', obj.itemSelector, function () {
                        ...
                        if ($this.is(obj.itemExclude))
                            return false;
                        animateAdd(that, _this.$unSelectedList, function () {
                            animateRemove(that);
                        });
                    ...
                    this.$unSelectedList.on('click', obj.itemSelector, function () {
                        ...
                        ;
                        animateAdd(that, _this.$selectedList, function () {
                            animateRemove(that);
                        });
                        _this.count += 1;
                        return false;
                ...
                restoreOrder: function (obj) {
                    ...
                    for (var i = 0; i < obj.category.length; i++) {
                        ...
                        if ($.inArray(t, defaults) == -1) {
                            var s = this.getItemString({
                                category: t,
                                name: obj.categoryName[i]
                            });
                    ...
                    ;
                    for (var i = 0; i < defaults.length; i++) {
                        var t = defaults[i], index = $.inArray(t, obj.category);
                        if (index > -1) {
                            var s = this.getItemString({
                                category: t,
                                name: obj.categoryName[index]
                            });
...
define('phooer/src/model/page/content', [
    'require',
    'exports',
    'module',
    'libs'
...
define('phooer/src/collection/page/ContentCollection', [
    'require',
    'exports',
    'module',
    'libs',
    'phooer/src/model/page/content'
], function (require, exports) {
    var libs = require('libs');
    var _ = libs.underscore;
    var $ = libs.jquery;
...
define('phooer/src/template/page/content.html', [], function () {
    return '\n<section data-is-video="False" hot-time="1467790278" class=" has_action" data-group-id="6304082590873682434" data-item-id="6304082590873682434" data-format="0">\n    <a href="/item/6304082590873682434/" class="article_link clearfix " data-action-label="click_headline">\n        <h3 class="dotdot line3 ">李克强总理在武汉长江干堤涉水而行指挥救灾</h3>\n        <div class="list_img_holder_large list_img_holder_large_fix" style="background: none;">\n            <img src="http://p3.pstatp.com/large/9ef000cd7adf7e10cd1" onerror="errorimg.call(this)" onload="loadimg.call(this)" style="opacity: 1;">\n        </div>\n        <div class="item_info">\n            <span class="hot_label space">热</span>\n            <span class="src space">中国政府网</span>\n            <span class="cmt space">评论&nbsp;640</span>\n            <span class="time" title="2016-07-06 15:31">1分钟前</span>\n            <span data-id="6304082590873682434" class="dislike-news  fr"></span>\n        </div>\n    </a>\n</section>\n\n<section data-is-video="False" hot-time="1468571796" class=" has_action" data-group-id="6307465096969355522" data-item-id="6307466763684545025" data-format="0">\n    <div class="one-px-border"></div>\n    <a href="#item/6307466763684545025/" class="article_link clearfix " data-action-label="click_headline" data-tag="news_photography">\n        <h3 class="dotdot line3 ">图虫风光摄影\uFF1A巴滨路</h3>\n        <div class="list_image">\n            <ul class="clearfix">\n                <li class="list_img_holder" style="background: none;"><img src="http://p3.pstatp.com/list/a8d00054e6ceffa061f" onerror="errorimg.call(this)" onload="loadimg.call(this)" style="opacity: 1;"></li>\n                <li class="list_img_holder" style="background: none;"><img src="http://p3.pstatp.com/list/a8c000550bfe255efd9" onerror="errorimg.call(this)" onload="loadimg.call(this)" style="opacity: 1;"></li>\n                <li class="list_img_holder" style="background: none;"><img src="http://p1.pstatp.com/list/a8f000521201c00ba75" onerror="errorimg.call(this)" onload="loadimg.call(this)" style="opacity: 1;"></li>\n            </ul>\n        </div>\n        <div class="item_info">\n            <span class="src space">走在路上看风景</span>\n            <!--\n            <span class="cmt space">评论&nbsp;0</span>\n            -->\n            <span class="time" title="2016-07-15 16:36">55分钟前</span>\n            <span data-id="6307465096969355522" class="dislike-news  fr"></span>\n        </div>\n    </a>\n</section>\n\n';
});
define('phooer/src/view/page/ContentView', [
    'libs',
    'phooer/src/collection/page/ContentCollection',
    'phooer/src/template/page/content.html'
], function (libs, Collection, template) {
    var libs = require('libs');
    var _ = libs.underscore;
    var $ = libs.jquery;
...
define('phooer/src/controller/page/ListController', [
    'libs',
    'phooer/src/view/page/ContentView',
    'phooer/src/collection/page/ContentCollection'
], function (libs, ContentView, ContentCollection) {
    var _ = libs.underscore;
    var $ = libs.jquery;
    var Backbone = libs.Backbone;
    var Marionette = libs.Marionette;
...
define('phooer/src/router/AppRouter', [
    'require',
    'exports',
    'module',
    'libs',
